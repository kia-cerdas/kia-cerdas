...
//             const SizedBox(height: 12),
//             const Text(
//               'Kontrol rutin penting untuk memastikan kesehatan Ibu '
...
//       if (week > 0 && week <= 12) {
//         return 'Ibu sedang di Trimester 1. Yuk cek kondisi awal kehamilan dan perkembangan janinmu!';
//       } else if (week > 12 && week <= 27) {
//         return 'Ibu sudah di Trimester 2. Yuk pantau pertumbuhan janin dan kesehatan Ibu!';
//       } else if (week > 27) {
//         return 'Trimester 3 sedang berjalan, Bun. Yuk cek kondisi kehamilanmu dan kesiapan persalinan!';
//       }
//     } else if (_selectedPhase == 'Nifas') {
//       return 'Masa nifas juga penting, Bun. Yuk cek pemulihan tubuh Ibu secara rutin!';
...
//     return 'Yuk cek kondisi kesehatan Ibu dan si kecil hari ini!';
//   }
