...
class PemeriksaanKehamilanModel {
  ...
  // ✅ Field AI Risk Score dari backend
  final int skorRisiko;
  final String statusRisiko;
  final String detailRisiko;
  ...
  factory PemeriksaanKehamilanModel.fromJson(Map<String, dynamic> json) {
    ...
    return PemeriksaanKehamilanModel(
      ...
      tripelEliminasi: str(json['tripel_eliminasi']),
      tataLaksanaKasus: str(json['tata_laksana_kasus']),
      // ✅ Mapping field AI Risk Score
      skorRisiko: toInt(json['skor_risiko']) ?? 0,
      statusRisiko: str(json['status_risiko']),
      detailRisiko: str(json['detail_risiko']),
    );
  }
}
