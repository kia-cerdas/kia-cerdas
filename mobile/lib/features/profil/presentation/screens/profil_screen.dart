...
class _ProfilScreenState extends State<ProfilScreen>
  ...
  Widget _buildRiwayatKehamilan(List<RiwayatKehamilanSingkat> list) {
    // Sembunyikan kehamilan yang sedang aktif (TRIMESTER 1/2/3)
    final filteredList = list.where((item) {
      return !item.statusKehamilan.toUpperCase().trim().startsWith('TRIMESTER');
    }).toList();
      ...
      children: [
          ...
          child: Row(children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  color: AppColors.blue50,
                  borderRadius: BorderRadius.circular(12)),
              child: Text('${filteredList.length} kehamilan',
                  style: TextStyle(
                      fontSize: 11,
                      color: AppColors.primary,
                      fontWeight: FontWeight.w600)),
        ...
        if (filteredList.isEmpty)
          ...
          ...filteredList.asMap().entries.map((entry) {
            ...
            final item = entry.value;
            return Padding(
              padding: EdgeInsets.only(bottom: i < filteredList.length - 1 ? 10 : 0),
              child: _buildRiwayatCard(item, i + 1),
            );
          }),
      ],
