...
import 'package:intl/intl.dart';
import 'package:ta_pa2_pa3_project/core/services/auth_session.dart';
// Import helper konfirmasi yang sudah kita buat
import 'package:ta_pa2_pa3_project/core/widgets/confirm_helper.dart';
// Jangan lupa import widget instruction-nya
import 'package:ta_pa2_pa3_project/features/kader/widgets/kader_page_instruction.dart';
import 'pemantauan_ibu_hamil_kader_api_service.dart';
import 'pemantauan_ibu_hamil_kader_model.dart';
...
class _VerifikasiPemantauanIbuHamilScreenState
  ...
  // Future<void> _verify(PemantauanIbuHamilKaderModel item) async {
  //   // 1. Panggil dialog konfirmasi menggunakan helper kita
  //   final confirmed = await context.showConfirm(
  //     title: 'Konfirmasi Tinjauan',
  //     message: 'Apakah Anda yakin data pemantauan dari Ibu ${item.namaIbu} sudah benar dan ingin ditandai sudah ditinjau?',
  //     confirmText: 'Ya, Tandai',
  //     cancelText: 'Periksa Lagi',
  //     primaryColor: Colors.pink.shade600, // Sesuaikan warna modul hamil
  //   );

  //   // 2. Jika kader memilih "Periksa Lagi" atau batal, hentikan proses
  //   if (!confirmed) return;

  //   final namaKader = AuthSession.userName ?? 'Kader';
  //   final tanggalVerifikasi = DateFormat('yyyy-MM-dd').format(DateTime.now());

  //   // 3. Jika dikonfirmasi, tampilkan loading dan lanjut ke API
  //   showDialog(
  //     context: context,
  //     barrierDismissible: false,
  //     builder: (_) => const Center(child: CircularProgressIndicator()),
  ...
  // }
    ...
    Future<void> _verify(PemantauanIbuHamilKaderModel item) async {
    // 1. Panggil dialog konfirmasi dengan pesan yang disesuaikan
    final confirmed = await context.showConfirm(
      title: 'Konfirmasi Tinjauan Keluhan',
      message: 'Pastikan Anda sudah memeriksa keluhan atau tanda bahaya '
               'yang dilaporkan oleh Ibu ${item.namaIbu}.'
               'Tandai sudah ditinjau jika data telah diverifikasi?',
      confirmText: 'Ya, Tandai',
      cancelText: 'Periksa Lagi',
          ...
          : _errorMessage.isNotEmpty
              ...
              : RefreshIndicator(
                  ...
                  child: ListView(
                    padding: const EdgeInsets.all(16),
                    children: [
                      // INSTRUKSI SINGKAT UNTUK KADER
                      const KaderPageInstruction(
                        text: 'Tinjau laporan kondisi kesehatan ibu hamil di sini. '
                              'Periksa keluhan yang dilaporkan, lalu klik "Tandai Sudah Ditinjau" '
