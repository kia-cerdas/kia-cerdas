              ...
              child: ListView(
                ...
                children: [
                  ...
                  const KaderPageInstruction(
                    text: 'Kalender ini diisi sendiri oleh ibu lewat '
                        'aplikasinya. Kader hanya memantau (tidak bisa '
                        'mengubah data) -- gunakan untuk menentukan ibu '
                        'mana yang perlu didatangi atau diingatkan.',
                  ),
                  _buildTotalStatsCard(rekap),
                  const SizedBox(height: 16),
                  _buildMonthSelector(rekap.bulanKe),
