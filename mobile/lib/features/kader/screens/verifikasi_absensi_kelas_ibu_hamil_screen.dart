...
class _VerifikasiAbsensiKelasIbuHamilScreenState
  ...
  Future<void> _verify(AbsensiKelasIbuHamilModel item) async {
    ...
    final confirmed = await context.showConfirm(
      ...
      message: 'Pastikan Ibu ${item.namaIbu} benar-benar hadir pada '
               'pertemuan ke-${item.pertemuanKe} sebelum Anda memberi paraf '
               'verifikasi. Lanjutkan verifikasi?',
      confirmText: 'Ya, Verifikasi',
      cancelText: 'Periksa Lagi',
      primaryColor: Colors.pink.shade600, // Warna tema ibu hamil
    );
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      const KaderPageInstruction(
                        text: 'Verifikasi daftar hadir ibu hamil di sini. '
                              'Pastikan ibu benar-benar menghadiri kelas, '
                              'lalu klik "Verifikasi Kehadiran" untuk memberi paraf digital.',
                      ),
                      const SizedBox(height: 14),
                      _buildSummaryRow(),
                      const SizedBox(height: 14),
