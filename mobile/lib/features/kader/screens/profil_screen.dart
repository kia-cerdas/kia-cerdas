...
import 'package:flutter/material.dart';
import 'package:flutter/services.dart'; // Ditambahkan untuk atur warna status bar
import 'package:ta_pa2_pa3_project/core/themes/app_colors.dart';
import 'package:ta_pa2_pa3_project/core/services/auth_session.dart';
import 'package:ta_pa2_pa3_project/core/widgets/confirm_helper.dart';
import 'package:ta_pa2_pa3_project/features/auth/presentation/screens/login_screen.dart';
...
class _ProfilScreenState extends State<ProfilScreen> {
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      // Bikin jam/sinyal di status bar jadi putih
      value: SystemUiOverlayStyle.light.copyWith(
        statusBarColor: Colors.transparent,
      ),
      child: Scaffold(
        backgroundColor: const Color(0xFFF0F4FA),
        // AppBar putih dihapus total di sini
        body: _futureProfil == null
            ? const Center(child: CircularProgressIndicator())
            : FutureBuilder<KaderProfilModel>(
                future: _futureProfil,
  ...
  Widget _buildContent(KaderProfilModel profil) {
    return SingleChildScrollView(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // ── Header Biru (Sekarang langsung nempel di atas) ──
          Container(
            width: double.infinity,
            color: AppColors.primary,
            child: SafeArea(
              bottom: false,
              child: Padding(
                padding: const EdgeInsets.fromLTRB(20, 24, 20, 24), // Jarak atas ditambah sedikit
                child: Row(
                  children: [
                    Container(
                      width: 56,
