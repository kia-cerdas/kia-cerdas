...
import {
  ...
  FileText, X, Calendar, BarChart3, Scale, Lightbulb, List,
...
const categories = {
  ...
  remaja: { name: "Remaja", color: "blue", range: "10-18 tahun", bgGradient: "from-blue-500 to-blue-600" },
  dewasa: { name: "Dewasa", color: "blue", range: "19-59 tahun", bgGradient: "from-blue-500 to-blue-600" },
  lansia: { name: "Lansia", color: "blue", range: "≥60 tahun", bgGradient: "from-blue-500 to-blue-600" }
};
...
export default function PencatatanKesehatanKategori() {
  ...
  // Fungsi untuk mendapatkan status kesehatan tanpa icon
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-7xl mx-auto p-6">
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <button onClick={() => { setRefreshing(true); fetchDataFromAPI(); }} disabled={refreshing} className="bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-blue-700">
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Usia</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Status Risiko</th>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <div className="ml-4">
                              ...
                              {patient.dusun && (
                                <div className="text-xs text-gray-500">{patient.dusun}</div>
                              )}
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{patient.nik || '-'}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{patient.usia} tahun</td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          {latest && (
                            <div className="text-xs text-gray-400 mt-1">
                              Terakhir: {new Date(latest.tanggal).toLocaleDateString("id-ID")}
                            </div>
                          )}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <div className="flex gap-2">
                            <button
                              ...
                              className="text-blue-600 hover:text-blue-900 bg-blue-50 hover:bg-blue-100 px-3 py-1 rounded-lg text-xs flex items-center gap-1"
                            >
                              <Eye size={14} /> Riwayat
                            </button>
                            {dapatDitambahkan ? (
                              ...
                              <button
                                disabled
                                className="text-gray-400 bg-gray-50 px-3 py-1 rounded-lg text-xs cursor-not-allowed flex items-center gap-1"
                              >
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-lg max-w-3xl w-full max-h-[80vh] overflow-y-auto">
                <div className="sticky top-0 bg-white border-b p-4 flex justify-between items-center">
                  <div>
                    <h2 className="text-xl font-bold text-blue-600">Riwayat Pemeriksaan</h2>
                  ...
                  {loadingHistory ? (
                    ...
                    <div className="space-y-4">
                      {allHistories.map((exam, idx) => (
                        <div key={exam.id || idx} className="border border-blue-100 rounded-lg p-3 hover:bg-blue-50 transition-colors">
                          ...
                          <div className="grid grid-cols-2 gap-2 text-sm mt-2">
                            {exam.tekanan_darah && <div><Heart size={12} className="inline text-blue-500" /> TD: {exam.tekanan_darah}</div>}
                            {exam.gula_darah && <div><Droplet size={12} className="inline text-blue-500" /> GDS: {exam.gula_darah} mg/dL</div>}
                            {exam.kolesterol && <div><FileText size={12} className="inline text-blue-600" /> Kolesterol: {exam.kolesterol} mg/dL</div>}
                            ...
                            {exam.imt && <div><BarChart3 size={12} className="inline text-blue-500" /> IMT: {typeof exam.imt === 'number' ? exam.imt.toFixed(1) : exam.imt}</div>}
                            {exam.kategori_risiko && (
                              <div>
                                Risiko: {exam.kategori_risiko}
                              </div>
                            )}
          ...
          {detailModal && detailData && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-lg max-w-2xl w-full max-h-[85vh] overflow-y-auto">
                <div className="sticky top-0 bg-white border-b p-4 flex justify-between items-center">
                  <div>
                    <h2 className="text-xl font-bold text-blue-600">Detail Pemeriksaan</h2>
                  ...
                  {loadingDetail ? (
                    ...
                    <div className="space-y-4">
                      <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                        <h3 className="font-semibold text-lg mb-2 text-blue-800">Hasil Pemeriksaan</h3>
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div>
                            ...
                            <p className={`font-bold ${
                              ...
                              detailData.kategori_risiko === "Normal" ? "text-blue-600" :
                              "text-gray-600"
                            }`}>
                      ...
                      {detailData.jawaban && Object.keys(detailData.jawaban).length > 0 && (
                        <div className="border border-blue-200 rounded-lg p-4">
                          <h3 className="font-semibold text-lg mb-3 text-blue-800">Data Pemeriksaan</h3>
          ...
          {modal === "checkup" && selectedPatient && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                <div className="sticky top-0 bg-white border-b p-4 flex justify-between items-center">
                  <div>
                    <h2 className="text-xl font-bold text-blue-600">Pemeriksaan {cat.name}</h2>
                ...
                {loadingForm ? (
                  ...
                  <form onSubmit={handleSaveDynamicCheckup} className="p-5 space-y-4">
                    ...
                    <div className="flex gap-3 pt-3">
                      <button type="submit" disabled={submitting} className="flex-1 bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 disabled:opacity-50 flex items-center justify-center gap-2">
                ...
                <div className="text-center">
                  <div className={`mx-auto w-16 h-16 rounded-full flex items-center justify-center text-2xl
                    ${resultData.kategori_risiko === "Tinggi" ? "bg-red-100 text-red-600" :
                      ...
                      resultData.kategori_risiko === "Normal" ? "bg-blue-100 text-blue-600" :
                      "bg-gray-100 text-gray-600"}`}>
                    {resultData.kategori_risiko === "Tinggi" && <AlertCircle size={32} />}
                    {resultData.kategori_risiko === "Sedang" && <AlertTriangle size={32} />}
                    {resultData.kategori_risiko === "Normal" && <CheckCircle size={32} />}
                    {(!resultData.kategori_risiko || resultData.kategori_risiko === "Belum Diperiksa") && <XCircle size={32} />}
                  </div>
                  <h3 className="text-xl font-bold mt-4 text-blue-600">Pemeriksaan Selesai</h3>
                  <div className="mt-4 p-3 rounded-lg bg-blue-50 border border-blue-200">
                    ...
                    <p className={`text-2xl font-bold
                      ${resultData.kategori_risiko === "Tinggi" ? "text-red-600" :
                        ...
                        resultData.kategori_risiko === "Normal" ? "text-blue-600" :
                        "text-gray-600"}`}>
