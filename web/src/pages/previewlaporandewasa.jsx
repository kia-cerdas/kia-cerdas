...
export default function LaporanDewasaPreview() {
  ...
  const fetchPreview = async () => {
    ...
    try {
      ...
      if (filterEnabled && startDate && endDate) {
        response = await previewLaporanDewasa(startDate, endDate);
      } else {
        response = await previewLaporanDewasa();
      }
      ...
      const msg =
        err.response?.data?.message || err.message || "Gagal memuat preview data dewasa";
      setError(msg);
      setData([]);
      setDynamicHeaders([]);
    } finally {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      a.href = url;
      const filename = `laporan_dewasa_${
      ...
      Swal.fire({
        ...
        text:
          "Gagal mengekspor laporan dewasa: " +
