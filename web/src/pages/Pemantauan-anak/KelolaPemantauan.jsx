    ...
    <MainLayout>
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="bg-slate-100/50 p-1 rounded-xl flex gap-1 overflow-x-auto">
          {rentangList.map((rentang) => (
            <button
              ...
              className={`flex-shrink-0 sm:flex-1 px-4 sm:px-2 py-2.5 text-sm font-medium rounded-lg transition-all whitespace-nowrap ${activeRentangId === String(rentang.id)
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
          {/* Desktop Header */}
          <div className={`hidden md:grid grid-cols-12 bg-slate-100 px-4 md:px-8 py-3.5 border-b border-slate-200 ${filteredData.length === 0 ? 'md:hidden' : ''}`}>
