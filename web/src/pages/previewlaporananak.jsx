  ...
  const fetchPreview = async () => {
    ...
    try {
      ...
      if (filterEnabled && startDate && endDate) {
        response = await previewLaporanAnak(startDate, endDate);
      } else {
        response = await previewLaporanAnak();
      }
      ...
      const msg =
        err.response?.data?.message || err.message || "Gagal memuat preview data anak";
      setError(msg);
      setData([]);
      setDynamicHeaders([]);
    } finally {
