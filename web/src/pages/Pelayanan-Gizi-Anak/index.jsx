...
import {
  Plus, Loader2, Check, X, Save,
  Utensils, Droplet, Info, ChevronRight, Calendar, ArrowLeft, User, Apple, Pill
} from 'lucide-react';
  ...
  return (
    <MainLayout>
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-8 bg-slate-50 min-h-screen font-sans">
        ...
        {/* HEADER SECTION */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8 pb-6 border-b border-slate-200">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-[#185FA5] rounded-xl flex items-center justify-center text-white shadow-md flex-shrink-0">
              <Apple size={22} />
            </div>
            <div>
              <h1 className="text-xl font-bold text-slate-800">Monitoring Gizi & Nutrisi</h1>
              <p className="text-slate-500 text-xs mt-0.5">Pantau perkembangan asupan nutrisi anak secara berkala.</p>
            </div>
          </div>
          {viewMode === 'LIST' && (
            <button
              onClick={handleOpenForm}
              className="flex items-center gap-2 bg-[#185FA5] hover:bg-[#185FA5]/90 text-white px-6 py-3 rounded-xl font-bold text-sm shadow-md transition-all active:scale-95"
            >
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-slate-100">
                    ...
                    <DataRow label="Diberikan ASI Pembantu" type="check" kolom={kolomBulan} getContent={getCellContent} fn={(d) => d.ASI?.asi_perah === "ya"} />
        ...
        {/* FORM SECTION */}
        {viewMode === 'FORM' && (
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col mt-6 animate-in fade-in zoom-in duration-200">

            {/* FORM HEADER */}
            <div className="px-6 py-5 border-b border-slate-100 flex justify-between items-center bg-white">
              <div>
                <h2 className="text-lg font-bold text-slate-800">Form Input Pelayanan Gizi</h2>
                <p className="text-xs text-slate-500 mt-1">
                  Petugas: <span className="font-semibold text-slate-700">{authUser.nama}</span> • Usia Anak: <span className="font-semibold text-slate-700">{ageNow} Bulan</span>
                </p>
              </div>
            </div>
                ...
                <div className="space-y-5">
                  <section className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                    <h4 className="text-sm font-bold text-slate-800 mb-3 flex items-center gap-2">
                      <Calendar size={18} className="text-[#185FA5]" /> Waktu Kunjungan
                    </h4>
                  ...
                  {parseInt(formData.bulan_ke) < 6 ? (
                    <section className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                      <h4 className="text-sm font-bold text-slate-800 mb-2 flex items-center gap-2">
                        <Droplet size={18} className="text-[#185FA5]" /> Pola Pemberian ASI
                      </h4>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1">
                          <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Gunakan ASI Pembantu?</label>
                          <select
                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2.5 text-sm outline-none"
                    ...
                    <section className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                      <h4 className="text-sm font-bold text-slate-800 mb-2 flex items-center gap-2">
                        <Droplet size={18} className="text-[#185FA5]" /> Pola Pemberian ASI & Susu
                      </h4>
                    ...
                    <section className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                      <h4 className="text-sm font-bold text-slate-800 mb-2 flex items-center gap-2">
                        <Droplet size={18} className="text-[#185FA5]" /> Pola Menyusui
                      </h4>
                      <div className="space-y-1">
                  ...
                  {parseInt(formData.bulan_ke) >= 24 && (
                    <section className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                      <h4 className="text-sm font-bold text-slate-800 flex items-center gap-2">
                        <Pill size={18} className="text-[#185FA5]" /> Pemberian Obat Cacing
                      </h4>
                  ...
                  {parseInt(formData.bulan_ke) < 6 ? (
                    <div className="space-y-2 py-2">
                      <div className="flex items-center gap-2 text-slate-700 font-bold text-sm">
                        <Utensils size={16} className="text-[#185FA5]" />
                        <span>MPASI Belum Tersedia</span>
                      </div>
                    ...
                    <section className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                      <div className="flex items-center justify-between mb-6">
                        <h4 className="text-sm font-bold text-slate-800 flex items-center gap-2">
                          <Utensils size={18} className="text-[#185FA5]" /> Status MPASI
                        </h4>
                      ...
                      {parseInt(formData.bulan_ke) >= 12 && parseInt(formData.bulan_ke) <= 24 && (
                        <div className="p-4 bg-blue-50 border border-blue-100 rounded-2xl flex items-start gap-3 mb-4">
                          <Info size={16} className="text-[#185FA5] shrink-0 mt-0.5" />
                      ...
                      {formData.mpasi.sudah_mpasi ? (
                        ...
                        <div className="flex items-center gap-2 py-2 text-slate-500 text-xs italic">
                          <Utensils size={14} className="text-slate-400" />
                          <span>Belum waktunya atau belum diberikan MPASI.</span>
                        </div>
                      )}
                    </section>
                  )}
            ...
            <div className="p-6 border-t border-slate-100 bg-white flex justify-end items-center gap-3">
              ...
              <button
                onClick={handleSave}
                disabled={submitting}
                className="px-8 py-2.5 bg-[#185FA5] hover:bg-[#185FA5]/90 text-white rounded-xl font-bold text-sm shadow-lg shadow-blue-100 transition-all flex items-center gap-2 disabled:opacity-50"
              >
